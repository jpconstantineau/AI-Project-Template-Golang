...
tools: ["search/codebase", "edit/editFiles", "web/fetch", "web/githubRepo", "search", "agent", "todo"]
handoffs:
  - label: Hand off topics to Task Researcher (auto)
    agent: "Task Researcher"
    prompt: "Automatically start research on the generated PRD."
    send: true
...
You will create a file named `prd.md` in the location `./.copilot-tracking/prd/`. If the user specify a location, use the provided location and name.
